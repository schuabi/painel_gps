...
#caminho_comparativo = comparativo
#caminho_nucleos = "linhas_e_nucleos.csv"
saida = "comparativo_programado_executado_com_nucleo.csv"

# Ler os arquivos CSV com separador ";"
#df_comparativo = pd.read_csv(caminho_comparativo, sep=";")
#df_nucleos = pd.read_csv(caminho_nucleos, sep=";")

# Realizar o merge baseado na coluna "Linha"
df_merged = pd.merge(
    comparativo,
...
# Exportar o resultado final com a nova coluna "Núcleo"
df_merged.to_csv(saida, index=False, sep=';')
